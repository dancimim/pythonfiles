...
def saldeductions():
    global current_weekly_hours_commuting
    global current_price_of_commute
    remote = input("Is the new job remote only? (y/n)", )
    if remote == 'y':
        ...
        while True:
            try:
                current_days_in_office = input("Enter amount of days each week in the office: ")
                current_days_in_office = int(current_days_in_office)
                break
            except ValueError:
                    print("Please enter a number...")
        while True:
            try:
                current_daily_commute_time = input("Enter total commute time per day: ")
        ...
        print("Total weekly price of commute is:", '£', format(current_weekly_price_of_commute, ".2f"))
        current_yearly_price_of_commute = current_weekly_price_of_commute * 47
        print("Total yearly price of commute is:", '£', format(current_yearly_price_of_commute, ".2f"))
        current_weekly_hours_lost_whilst_commuting = current_daily_commute_time * current_days_in_office
        current_weekly_value_of_commuting_hours = current_weekly_hours_lost_whilst_commuting * new_hourly_salary
        ...
        print("Your total weekly cost of commuting is:", '£', format(current_total_weekly_cost_of_commute, ".2f"))
        print("Your total yearly cost of commuting is:", '£', format(current_total_yearly_cost_of_commute, ".2f"))
saldeductions()
